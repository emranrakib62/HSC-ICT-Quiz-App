...
public class Activity44 extends AppCompatActivity {
    ...
    private void initializeQuestions() {
        ...
        questionList.add(new Question("১. ডেটাবেজ ম্যানেজমেন্টের ধারণা কী?",
                new String[] {"ডেটার বিশ্লেষণ পদ্ধতি", "ডেটা সংরক্ষণ, সংগঠন ও পরিচালনার পদ্ধতি", "ডেটা নিরাপত্তা বৃদ্ধি", "ডেটা এনক্রিপশন পদ্ধতি"}, 1));

        questionList.add(new Question("২. ডেটাবেজ ম্যানেজমেন্ট সিস্টেম (DBMS) কী?",
                new String[] {"ডেটা সুরক্ষা ব্যবস্থা", "ডেটা পরিচালনা করার সফটওয়্যার", "ডেটা বিশ্লেষণ পদ্ধতি", "ডেটা সংরক্ষণ পদ্ধতি"}, 1));

        questionList.add(new Question("৩. DBMS এর প্রাথমিক কাজগুলো কী?",
                new String[] {"ডেটা বিশ্লেষণ", "ডেটা সুরক্ষা, এনক্রিপশন ও ব্যাকআপ", "ডেটা সংরক্ষণ, প্রবাহ ও পুনরুদ্ধার", "ডেটাবেজ মডেলিং"}, 2));

        questionList.add(new Question("৪. রিলেশনাল ডেটাবেজ ম্যানেজমেন্ট সিস্টেম (RDBMS) কী?",
                new String[] {"ডেটা শেয়ারিং সিস্টেম", "ডেটা খোঁজার জন্য সফটওয়্যার", "ডেটা টেবিল আকারে সংরক্ষণ করা হয়", "ডেটা এক্সপোর্ট পদ্ধতি"}, 2));

        questionList.add(new Question("৫. রিলেশনাল ডেটাবেজ ম্যানেজমেন্ট সিস্টেমের বৈশিষ্ট্য কী?",
                new String[] {"ডেটা শেয়ারিং", "ডেটা টেবিল আকারে সংরক্ষণ, সম্পর্ক সৃষ্টি", "ডেটা এনক্রিপশন", "ডেটা সিকিউরিটি"}, 1));

        questionList.add(new Question("৬. রিলেশনাল ডেটাবেজ ম্যানেজমেন্ট সিস্টেমের ব্যবহার কী?",
                new String[] {"ডেটা ব্যবস্থাপনা, কুয়েরি তৈরি, রিপোর্ট তৈরির জন্য", "ডেটাবেজ ব্যাকআপ নেওয়া", "ডেটা বিশ্লেষণ", "ডেটা এনক্রিপশন পদ্ধতি"}, 0));

        questionList.add(new Question("৭. ডেটাবেজ তৈরি করার জন্য কোন পদক্ষেপ নিতে হয়?",
                new String[] {"কোড লেখা, কুয়েরি তৈরি", "ফাংশন তৈরি", "স্কিমা ডিজাইন, টেবিল তৈরি", "ডেটাবেজ ইন্ডেক্সিং, ব্যাকআপ নেওয়া"}, 2));

        questionList.add(new Question("৮. কুয়েরি কী?",
                new String[] {"ডেটাবেজ সুরক্ষা", "ডেটা সংরক্ষণের পদ্ধতি", "ডেটাবেজ থেকে তথ্য অনুসন্ধানের ভাষা", "ডেটা পদ্ধতির ডিজাইন"}, 2));

        questionList.add(new Question("৯. ডেটাবেজ সাজানোর জন্য কোন পদক্ষেপ প্রযোজ্য?",
                new String[] {"ফাংশন তৈরি করা", "ডেটাবেজ তৈরি করা", "টেবিল তৈরি ও কুয়েরি সাজানো", "ডেটা ইন্ডেক্সিং"}, 2));

        questionList.add(new Question("১০. ডেটাবেজ ইন্ডেক্স করার কাজ কী?",
                new String[] {"তথ্য দ্রুত খোঁজার জন্য ডেটাবেজে ইন্ডেক্স তৈরি করা", "ডেটা সুরক্ষা", "ডেটা বিশ্লেষণ করা", "ডেটা ইমপোর্ট করা"}, 0));

        questionList.add(new Question("১১. ডেটাবেজ রিলেশন কী?",
                new String[] {"ডেটা পুনরুদ্ধারের পদ্ধতি", "টেবিলগুলির মধ্যে সম্পর্ক", "তথ্য সংরক্ষণের পদ্ধতি", "ডেটা সিকিউরিটি ব্যবস্থাপনা"}, 1));

        questionList.add(new Question("১২. কর্পোরেট ডেটাবেজের ব্যবহার কী?",
                new String[] {"বিভিন্ন ছোট প্রতিষ্ঠানের ডেটাবেজ পরিচালনা", "সরকারি ডেটাবেজ পরিচালনা", "বড় প্রতিষ্ঠানগুলোর ডেটা পরিচালনা", "ব্যক্তিগত ডেটাবেজ পরিচালনা"}, 2));

        questionList.add(new Question("১৩. সরকারি প্রতিষ্ঠানে ডেটাবেজের ব্যবহার কী?",
                new String[] {"ডেটা এনক্রিপশন", "ব্যক্তিগত তথ্য সংরক্ষণ", "সরকারি কার্যক্রমের তথ্য সংগ্রহ ও পরিচালনা", "ব্যবহারকারীর ডেটা নিরাপত্তা"}, 2));

        questionList.add(new Question("১৪. ডেটা সিকিউরিটি কী?",
                new String[] {"ডেটার নিরাপত্তা নিশ্চিত করার পদ্ধতি", "ডেটা বিশ্লেষণ পদ্ধতি", "ডেটা এক্সপোর্ট পদ্ধতি", "ডেটা সংগ্রহের পদ্ধতি"}, 0));

        questionList.add(new Question("১৫. ডেটা এনক্রিপশন কী?",
                new String[] {"ডেটা আউটপুট প্রদর্শন করা", "ডেটাকে নিরাপদ করার জন্য এনক্রিপ্ট করা", "ডেটা সুরক্ষিত রাখা", "ডেটা রিলেশন তৈরি করা"}, 1));

        questionList.add(new Question("১৬. DBMS কি ধরনের ডেটাবেজ ব্যবস্থাপনা করে?",
                new String[] {"নন-রিলেশনাল", "হায়ারার্কিকাল", "অবজেক্ট-রিলেশনাল", "রিলেশনাল"}, 3));
        ...
        questionList.add(new Question("১৮. RDBMS এ ডেটার প্রধান উপাদান কী?",
                new String[] {"ফাইল", "ডিরেক্টরি", "টেবিল", "ব্লক"}, 2));
        ...
        questionList.add(new Question("২০. ডেটাবেজের সঠিক আর্কিটেকচার কী?",
                new String[] {"কনসেপ্টুয়াল, লজিক্যাল, ফিজিক্যাল", "ফিজিক্যাল, ফাইল, স্টোরেজ", "কনসেপ্টুয়াল, স্টোরেজ, পিজিক্যাল", "লজিক্যাল, পিজিক্যাল, স্টোরেজ"}, 0));

        questionList.add(new Question("২১. DBMS এর নিরাপত্তা ব্যবস্থা কী?",
                new String[] {"ফাইল সিকিউরিটি", "ডেটাবেজ ব্যাকআপ", "ক্লাউড স্টোরেজ", "ইউজার অথেনটিকেশন এবং অথোরাইজেশন"}, 3));
        ...
        questionList.add(new Question("২৩. ফাংশনাল ডেটাবেজের একটি বৈশিষ্ট্য কী?",
                new String[] {"ডেটার পুনরুদ্ধার গতি", "ডেটা স্টোরেজ টেবিল আকারে", "ফাইলের সিকিউরিটি", "ব্যক্তিগত ডেটাবেজ ব্যবস্থাপনা"}, 1));

        questionList.add(new Question("২৪. কোন ডেটাবেজ মডেল ডেটা আকারে টেবিল গঠন করে?",
                new String[] {"অবজেক্ট-ওরিয়েন্টেড মডেল", "রিলেশনাল ডেটাবেজ মডেল", "হায়ারার্কিকাল ডেটাবেজ মডেল", "নেটওয়ার্ক ডেটাবেজ মডেল"}, 1));

        questionList.add(new Question("২৫. ডেটাবেজ রিলেশন তৈরি করার কাজটি কী?",
                new String[] {"কুয়েরি তৈরি", "টেবিলগুলির মধ্যে সম্পর্ক সৃষ্টি", "ডেটার শ্রেণী তৈরি", "ডেটা পুনরুদ্ধার"}, 1));
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(50000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(Activity44.this, "Time's up!", Toast.LENGTH_SHORT).show();
